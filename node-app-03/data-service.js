...
module.exports.updateEmployee = function(employeeData) {
    return new Promise((resolve, reject) => {
        employees.forEach(e => {
            if (e.employeeNum == employeeData.employeeNum) {
                e.employeeNum = employeeData.employeeNum;			
                e.firstName = employeeData.firstName;
                e.lastName = employeeData.lastName;
                e.email = employeeData.email;
                e.SSN = employeeData.SSN;
                e.addressStreet = employeeData.addressStreet;
                e.addressCity = employeeData.addressCity;
                e.addressState = employeeData.addressState;
                e.addressPostal = employeeData.addressPostal;
                e.maritalStatus = employeeData.maritalStatus;
                e.isManager = employeeData.isManager;
                e.employeeManagerNum = employeeData.employeeManagerNum;
                e.status = employeeData.status;
                e.department = employeeData.department; 
                e.hireDate = employeeData.hireDate;
            }
        });
        resolve();
    });
...
module.exports.getEmployeesByManager = function(manager) {
    ...
    return new Promise((resolve, reject) => {
        employees.forEach(emp => {
            if (emp.employeeManagerNum == manager)
